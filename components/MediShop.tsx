     ...
     style={{
        ...
        backgroundPosition: "center",
            ...
            <div className="flex items-center justify-center z-10 p-8 ">
              ...
              <div className="bg-white rounded-[5px] shadow-lg px-8 py-12 flex flex-col items-center gap-6 my-8  mx-4">
                      <h1 className='font-bold text-3xl'>
                        <span className='text-[#1BA9B5]'>Shop</span>
                        <span className='text-[#10217D]'> for Medicines & Welness</span>  
                        <ShoppingCart size={40} color="#10217D" className='inline-block ' /> 
                      </h1>
